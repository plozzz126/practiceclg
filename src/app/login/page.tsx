...
const stack = ["React", "Next.js", "Go", "PostgreSQL", "Figma", "CTF"];
        ...
        <div className="flex flex-col justify-between bg-teal-700 p-8 text-white md:p-12">
          <div>
            ...
            <p className="mt-12 max-w-sm text-lg leading-8 text-teal-50">
              Находи проекты, тиммейтов и возможности под свой стек. DevLink держит заявки, дедлайны и
              командный чат в одном рабочем пространстве.
            </p>
          </div>
          <div className="mt-10 rounded-[8px] border border-white/20 bg-white/12 p-5">
            <p className="text-sm text-teal-50">Популярный стек</p>
